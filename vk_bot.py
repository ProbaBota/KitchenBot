    ...
    # ШКАФ (4 вопроса + телефон)
        ...
        if current_step == 1:
            ...
            send_message(
                ...
                f"• ❓ Указать приблизительные размеры\n"
                f"• ❔ Указать что еще не знаете размер\n\n"
                f"Какие примерные размеры?\n\n"
                f"Для прямой кухни просто число (3м), для угловой - 2 размера (3х2.5), для П-образной  и островной кухни - 3 размера (3х2.5х3)\n\n"
                f"Просто напишите размеры в чат или выберите вариант:",
                get_size_keyboard()
            )
            data['waiting_for_size_type'] = True
